          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-16">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em] leading-loose">
                ...
                Hosting: <a href="https://billing.empowerservers.com/aff.php?aff=294" target="_blank" rel="noopener noreferrer" className="text-tactical-orange hover:underline">High-Performance Nodes</a>
              </p>
            </div>
          </div>
